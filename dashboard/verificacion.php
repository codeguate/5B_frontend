            ...
            <div class="m-auto w-75 h-auto fondo-form shadow">
                    ...
                    <form autocomplete="off" class="mt-auto">
                        ...
                        <div class="form-group">
                            ...
                            <input disabled type="hidden" class="form-control" id="id_hidden" name="id_hidden">
                        ...
                        <div class="form-group w-100 text-center">
                            <button type="button" class="m-auto w-75 btn btn-info" id="registrarBTN" onclick="registrar1()">Registrar</button>
                            <button type="button" style="cursor:pointer;" class="btn btn-success m-auto w-75 d-none" id="guardar">Registrado</button>
                        </div>
